...
(function (global) {
  function computeDuty(state) {
    ...
    const catalogExtrap = hasDutyPoint
      ...
      : { hasCatalog: catalogHeadStatus.hasCatalog, outside: false, below: false, above: false };
    ...
    const cavOk = hasDutyPoint && ratioActual >= npshRatio && margin >= npshMarginAbs;
    ...
    return {
      ...
      speedTargetAffinity, speedTargetAffinityOk, minVfd,
      econ, en,
      visc, viscActive, viscHighRisk, viscModelScreening, curveEstimated,
      catalogHeadStatus, catalogHeadFlattened, catalogExtrap, catalogExtrapolated,
      fluidPropsEstimated,
