...
(function (global) {
  function computeDuty(state) {
    ...
    const dutyQ = dutyPoint.Q > 0 ? dutyPoint.Q : selectedQ;
    ...
    const speedForDuty = PM.speedForDuty(effPump, dutyQ, dutyHsys);
