...
window.pumpMetrics = function (state) {
  ...
  return {
    ...
    flags: [
      ...
      duty.catalogExtrapolated && "duty extra.",
      duty.catalogRatedExtrapolated && "rated extra.",
      duty.catalogSelectedExtrapolated && "target extra.",
      duty.catalogEtaEstimated && "eta est.",
      duty.catalogNpshrEstimated && "NPSHr est.",
      duty.catalogHeadFlattened && "head flat.",
      (duty.minVfdClamped || duty.minVfdInvalid) && "min VFD",
      duty.fluidPropsEstimated && "fluid est.",
      duty.transitionalFlow && "Re trans.",
      duty.minorLossesApprox && "K generic",
      duty.viscModelScreening && "visc coeff.",
